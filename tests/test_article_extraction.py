...
@pytest.mark.parametrize("datetime_string, format_string, expected_iso_string", [
    ("PHOENIX, Ariz. — Oct 13, 2018, 6:42 PM ET", "MMMDYYYYh:mmA", "2018-10-13T18:42:00"),
    ("WASHINGTON, May 25, 2010 --", "MMMMDDYYYY", "2010-05-25T00:00:00"),
    ("KABUL, Afghanistan, Aug. 31, 2009", "MMMDYYYY", "2009-08-31T00:00:00"),
    ("ANCHORAGE, ALASKA, July 7, 2009", "MMMMDYYYY", "2009-07-07T00:00:00"),
    ("Feb 6, 2011", "MMMDYYYY", "2011-02-06T00:00:00"),
    ("WASHINGTON, April 19 , 2011", "MMMMDDYYYY", "2011-04-19T00:00:00"),
    ("Sept. 15, 2009", "MMMDDYYYY", "2009-09-15T00:00:00"),
    ("Feb.17, 2010", "MMMDDYYYY", "2010-02-17T00:00:00"),
    ("Jan., 27, 2010", "MMMDDYYYY", "2010-01-27T00:00:00"),
    ("July 2010", "MMMMYYYY", "2010-07-01T00:00:00"),
    ("2012-12-16", "YYYY-MM-DD", "2012-12-16T00:00:00"),
    ("July 8 ,2013", "MMMMDYYYY", "2013-07-08T00:00:00")
])
def test_extract_datetime_abcnews_variants(datetime_string, format_string, expected_iso_string):
    assert extract_datetime_string(datetime_string, format_string, simplified_formats=True) == expected_iso_string
